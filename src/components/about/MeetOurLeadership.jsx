            ...
            <div className="about-container team-layout">
                ...
                <div className="team-slider-container">
                    <div className="team-slider" ref={sliderRef}>
                        {team.map((member, idx) => (
                            member.isMore ? (
                                <div key="more" className="team-card more-card">
                    ...
                    <div className="slider-nav-overlay">
                        <button className="slider-nav-btn prev" onClick={scrollLeft} aria-label="Previous">
                            <ChevronLeft size={24} />
                        </button>
                        <button className="slider-nav-btn next" onClick={scrollRight} aria-label="Next">
